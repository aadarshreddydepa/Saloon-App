      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.keyboardView}>
        <ScrollView contentContainerStyle={styles.scrollView}>
          <View style={styles.header}>
            ...
            <Text style={[styles.subtitle, { color: theme.text, opacity: 0.6 }]}>Login to continue</Text>
          </View>
          ...
          <View style={[styles.formContainer, { backgroundColor: theme.card }]}>
            ...
            <View style={styles.registerContainer}>
              <Text style={[styles.registerText, { color: theme.text, opacity: 0.6 }]}>Don't have an account? </Text>
...
const styles = StyleSheet.create({
  ...
  formContainer: { borderRadius: 30, padding: 30, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 10, elevation: 5 },
  inputContainer: { flexDirection: 'row', alignItems: 'center', borderRadius: 15, paddingHorizontal: 15, marginBottom: 16, height: 55 },
  inputIcon: { marginRight: 10 },
  input: { flex: 1, fontSize: 16 },
  loginButton: { borderRadius: 15, paddingVertical: 16, alignItems: 'center', marginTop: 10, marginBottom: 20 },
