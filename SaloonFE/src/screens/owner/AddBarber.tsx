  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      <View style={[styles.header, { backgroundColor: theme.card }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.text }]}>Add Barber</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView style={styles.content}>
        <View style={[styles.infoCard, { backgroundColor: theme.card }]}>
          ...
          <Text style={[styles.infoText, { color: theme.text }]}>
            Barber must first register as a user with user_type='barber', then you can assign them to your salon.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  infoCard: { flexDirection: 'row', padding: 20, borderRadius: 15, marginBottom: 20 },
  infoText: { flex: 1, marginLeft: 15, fontSize: 14, lineHeight: 20 },
  instruction: { fontSize: 16, lineHeight: 28, marginTop: 20 },
});
