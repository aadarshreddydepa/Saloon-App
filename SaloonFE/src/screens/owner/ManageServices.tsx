...
export default function ManageServices() {
  ...
  const renderService = ({ item }: any) => (
    <View style={[styles.serviceCard, { backgroundColor: theme.card }]}>
      ...
      <Text
        style={[styles.serviceDescription, { color: theme.text, opacity: 0.6 }]}
      >
...
const styles = StyleSheet.create({
  ...
  serviceName: { fontSize: 18, fontFamily: fonts.heading.bold, flex: 1 },
  servicePrice: { fontSize: 18, fontFamily: fonts.heading.bold },
  serviceDescription: {
    fontSize: 14,
    marginBottom: 12,
  ...
  status: { fontSize: 12, fontFamily: fonts.body.semiBold },
