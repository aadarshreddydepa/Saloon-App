  ...
  const handleGetLocation = async () => {
    try {
      ...
      if (addressResults.length > 0) {
        ...
        Alert.alert(
          "Location Found",
          "Address and coordinates updated successfully"
        );
      }
    } catch (error) {
            ...
            {formData.latitude !== "0.0" && formData.longitude !== "0.0" && (
              ...
              >
                ...
                <Text style={[styles.coordinatesText, { color: theme.text }]}>
                  Lat: {parseFloat(formData.latitude).toFixed(4)}, Long:{" "}
...
const styles = StyleSheet.create({
  ...
  addGalleryText: { marginLeft: 5, fontFamily: fonts.body.semiBold },
  emptyGalleryText: {
    textAlign: "center",
    fontSize: 14,
    paddingVertical: 30,
  ...
  locationLabel: { fontSize: 14, fontFamily: fonts.body.semiBold },
  locationButton: {
    flexDirection: "row",
    alignItems: "center",
  ...
  timePickerLabel: { fontSize: 11, fontFamily: fonts.body.regular },
  timePickerValue: {
    fontSize: 16,
    fontFamily: fonts.body.semiBold,
    marginTop: 2,
