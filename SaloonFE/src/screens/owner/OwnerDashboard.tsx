  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const todayCompletedBookings = todayBookings.filter(
        (b: any) => b.status === "completed" && b.barber !== null
      );
      ...
      >
        <View style={styles.section}>
          ...
          <View style={styles.statsGrid}>
            ...
            />
            <StatCard
              title="Valid Bookings"
              value={stats.todayValidBookings}
              icon="calendar"
              color="#2196F3"
            />
          </View>
          <View style={styles.statsGrid}>
            <StatCard
              ...
              value={stats.todayCompletedBookings}
              icon="checkmark-done"
              color="#FF9800"
            />
            <StatCard
        ...
        <View style={styles.section}>
          ...
          {recentBookings.length > 0 ? (
              ...
              >
                ...
                <View style={styles.bookingContent}>
                  <View style={styles.bookingHeader}>
                    <Text
                      style={[styles.bookingCustomer, { color: theme.text }]}
                      numberOfLines={1}
                    >
            ...
            <View
              style={[styles.emptyActivity, { backgroundColor: theme.card }]}
            >
              <Ionicons
              ...
              />
              <Text
                style={[styles.emptyText, { color: theme.text, opacity: 0.6 }]}
              >
                No recent bookings
              </Text>
            </View>
          ...
          {stats.totalSalons === 0 && (
            ...
            >
              ...
              <Text style={styles.getStartedText}>
                Get Started - Add Your First Salon!
              </Text>
            </TouchableOpacity>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 22, fontFamily: fonts.heading.bold },
  viewAllText: { fontSize: 14, fontFamily: fonts.body.semiBold },
  statsGrid: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginBottom: 15,
  ...
  bookingCustomer: { fontSize: 15, fontFamily: fonts.body.semiBold, flex: 1 },
  bookingTime: { fontSize: 12, marginLeft: 8, fontFamily: fonts.body.regular },
  bookingService: { fontSize: 13, fontFamily: fonts.body.regular },
  emptyActivity: {
    padding: 40,
    borderRadius: 15,
    alignItems: "center",
