...
export default function SalonListScreen() {
  ...
  const renderSalon = ({ item }: any) => (
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate("SalonDetail" as never, {
          id: item.id,
          from: "customer",
        })
      }
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      <View style={[styles.header, { backgroundColor: theme.card }]}>
        ...
        <TouchableOpacity
          onPress={() => setSortBy(sortBy === "rating" ? "distance" : "rating")}
        >
...
const styles = StyleSheet.create({
  ...
  salonName: { fontSize: 18, fontFamily: fonts.heading.semiBold, flex: 1 },
  activeBadge: {
  ...
  ratingText: { fontSize: 14, marginLeft: 6, fontFamily: fonts.body.semiBold },
  hours: { fontSize: 12, fontFamily: fonts.body.regular },
