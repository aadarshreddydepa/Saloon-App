...
export default function RegisterScreen() {
  ...
  const theme = isDark
    ...
    : { bg: '#F5F5F5', card: '#FFFFFF', text: '#000000', primary: '#000000', inputBg: '#FFFFFF', border: '#E0E0E0' };
          ...
          {userTypes.map((type) => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor: formData.user_type === type.value ? theme.primary : theme.inputBg,
                  borderColor: formData.user_type === type.value ? theme.primary : theme.border,
                },
              ]}
              onPress={() => {
            ...
            >
              <Ionicons
                ...
                size={24}
                color={formData.user_type === type.value ? (isDark ? '#000' : '#FFF') : theme.text}
              />
              <Text
                style={[
                  styles.userTypeText,
...
const styles = StyleSheet.create({
  ...
  userTypeButton: { flex: 1, flexDirection: 'column', alignItems: 'center', padding: 16, borderRadius: 12, marginHorizontal: 4, borderWidth: 2 },
  userTypeText: { fontSize: 12, marginTop: 8, fontWeight: '600' },
  inputContainer: { flexDirection: 'row', alignItems: 'center', borderRadius: 12, paddingHorizontal: 16, marginBottom: 16, height: 56 },
  input: { flex: 1, marginLeft: 12, fontSize: 16 },
  registerButton: { height: 56, borderRadius: 12, justifyContent: 'center', alignItems: 'center', marginTop: 8 },
