  ...
  return (
    <View style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      <Animated.View style={{ opacity: fadeAnim }}>
        ...
        <Text style={[styles.subtitle, { color: accentColor }]}>Your Style, Your Time</Text>
      </Animated.View>
...
const styles = StyleSheet.create({
  ...
  loader: { position: 'absolute', bottom: 80, width: width * 0.6, height: 4, backgroundColor: 'rgba(192,192,192,0.3)', borderRadius: 2, overflow: 'hidden' },
